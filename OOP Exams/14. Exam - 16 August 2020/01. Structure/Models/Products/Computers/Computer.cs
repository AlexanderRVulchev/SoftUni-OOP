...
namespace OnlineShop.Models.Products.Computers
{
    ...
    public abstract class Computer : Product, IComputer
    {
        ...
        public IComponent RemoveComponent(string componentType) // return IComponent or String?? Description unclear
        {
            return components.Find(x => x.GetType().Name == componentType);
        }
        ...
        public override string ToString()
        {
            ...
            double averagePerformance = peripherals.Count > 0 ? components.Average(x => x.OverallPerformance) : 0;
            sb.AppendLine($" Peripherals ({peripherals.Count}); Average Overall Performance ({averagePerformance}):");
            if (peripherals.Any())
